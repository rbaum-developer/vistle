...
public:
    ...
    enum StressSupport { SOLID, SHELL, AXI_SHELL, PLANE, BEAM3, BEAM4, LINK, THERMAL_SOLID, THERMAL_PLANE, NO_STRESS };
    enum SHELL_RESULT { TOP, BOTTOM, AVERAGE };

    int ElementType(int routine, int noCovNodes);

    StressSupport getStressSupport(int routine);
    int getVistleType(int routine);
