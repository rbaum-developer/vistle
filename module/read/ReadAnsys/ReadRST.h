...
public:
    ...
    /** Get number of sets
       ...
       */
    int getNumTimeSteps() { return rstheader_.numsets_; }
    ...
    /** Get number of nodes
       ...
       */
    int getNumNodes() { return anznodes_; }
    ...
    /** Get ANSYS version
       ...
       */
    int getVersion() { return header_.version_; }
